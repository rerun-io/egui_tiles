...
`release-plz` (see `.github/workflows/release_plz.yml`) prepares the changelog
and the version bump as a PR. The steps below are the manual fallback, and what
to do after that PR lands.
